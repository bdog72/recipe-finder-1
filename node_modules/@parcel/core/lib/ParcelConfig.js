...
class ParcelConfig {
  ...
  isGlobMatch(filePath, pattern, pipeline) {
    ...
    return (pipeline === patternPipeline || !pipeline && !patternPipeline) && ((0, _micromatch().isMatch)(filePath, patternGlob, {
      dot: true
    }) || (0, _micromatch().isMatch)((0, _path().basename)(filePath), patternGlob, {
      dot: true
    }));
  }
